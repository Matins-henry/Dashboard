      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400">
            Start your journey with LifeBoard
          </p>
        </div>
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.1] rounded-2xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="w-4 h-4 mt-0.5 rounded border-white/[0.2] bg-white/[0.03] text-emerald-500 focus:ring-emerald-500/50"
              />
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white/[0.03] text-zinc-500">or sign up with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="
              py-3 px-4 bg-white/[0.03] hover:bg-white/[0.05]
